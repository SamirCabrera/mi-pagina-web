...
import { Slider3dService } from 'src/app/services/slider3d/slider3d.service';
...
export class Slider3dComponent implements OnInit, OnDestroy, OnChanges {
  ...
  buildCarousel(slides, options) {
    this.$carouselService = new Slider3dService(this.slides, this.options);
